...
class FlutterWebViewClient {
  ...
  // ajanuw
  Handler myHandlerUrl;
  Handler myHandlerWebResourceRequest;
  ...
  FlutterWebViewClient(MethodChannel methodChannel) {
    ...
    myHandlerWebResourceRequest = new Handler() {
      @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
      @Override
      public void handleMessage(Message msg) {
        msgHandle2((WebResourceRequest)msg.obj);
        super.handleMessage(msg);
      }
    };
  }
  ...
  @SuppressLint("NewApi")
  @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
  private void msgHandle2(WebResourceRequest request) {
    Map<String, Object> args = new HashMap<>();
    args.put("url", request.getUrl().toString());
    args.put("method", request.getMethod());
    args.put("headers", request.getRequestHeaders());
    args.put("hasGesture", request.hasGesture());
    args.put("isForMainFrame", request.isForMainFrame());
    args.put("isRedirect", request.isRedirect());
    methodChannel.invokeMethod("onRequest2", args);
  }
  ...
  private void onRequest(WebView view, String url) {
    ...
    msg.obj = url;
    myHandlerUrl.sendMessage(msg);
  }
  private void onRequest2(WebView view, WebResourceRequest request) {
    Message msg = new Message();
    msg.obj = request;
    myHandlerWebResourceRequest.sendMessage(msg);
  }
  ...
  private WebViewClient internalCreateWebViewClient() {
    return new WebViewClient() {
      ...
      public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
        FlutterWebViewClient.this.onRequest(view, url);
      ...
      public WebResourceResponse shouldInterceptRequest(WebView view, WebResourceRequest request) {
        FlutterWebViewClient.this.onRequest2(view, request);

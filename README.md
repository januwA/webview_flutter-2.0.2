...
- 来至[webview_flutter 2.0.2](https://pub.flutter-io.cn/packages/webview_flutter)
- 添加 `onRequest(String url)` 和 `onRequest2(Map<String, dynamic> request)` API 监听WebView中所有的网络请求
...
dependencies:
  webview_flutter:
    git:
      url: https://github.com/januwA/webview_flutter-2.0.2.git
      ref: main
```
